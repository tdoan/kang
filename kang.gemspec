...
spec = Gem::Specification.new do |spec|
  ...
  spec.add_dependency("glib2", "= 1.2.2")
  spec.add_dependency("atk", "= 1.2.2")
  spec.add_dependency("gtk2", "= 1.2.2")
  spec.add_dependency("pango", "= 1.2.2")
  spec.add_dependency("cairo", "= 1.12.3")
  spec.add_dependency("gdk_pixbuf2", "= 1.2.2")
  spec.has_rdoc = false
end
